...
* Il ne faut pas créer, dans le OneDrive salarié, de raccourcis pointant vers des dossiers ou fichiers provenant du OneDrive CEN-NA afin d'éviter tout problème de synchronisation.
...
![](images/dossier.png) &nbsp; [07_Dossiers_transversaux](https://conservatoirena.sharepoint.com/sites/07_Dossiers_transversaux/Documents%20partages/Forms/AllItems.aspx) (Sharepoint)
...
<p style="text-align: center;">![](images/fenetre_partage_2.PNG)</p>

<p style="text-align: center;">![](images/parametres_partage_3.PNG)</p>
...
Pour partager un élément avec des personnes extérieures au CEN-NA, la méthode est la même que précedemment; il vous suffit de sélectionner "Personnes de votre choix" comme type d'autorisation puis de cliquer sur "Appliquer":

<p style="text-align: center;">![](images/parametres_partage_2.PNG)</p>

<p style="text-align: center;">![](images/parametres_partage_3.PNG)</p>


Il vous suffira ensuite de simplement renseigner les adresses mail des personnes dans l'encart :
