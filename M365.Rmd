...
<u>Remarque</u> : 
<font size="3"><i>Cette fonctionnalité implique forcément une consommation de l'espace de stockage du disque dur de votre PC puisque vous télécharger localement une copie des fichiers/dossiers sélectionnés précedemment du OneDrive. Il est donc important de n'utiliser cette fonctionnalité que sur des éléments ne représentant pas un trop gros volume de données. Une fois le travail "hors-connexion" terminé il est également recommandé de rendre de nouveau ces élements accessibles uniquement en ligne de manière à libérer de l'espace sur votre ordinateur.
Pour se faire, la démarche à suivre est très simple: il vous suffit de faire un clic-droit sur les fichiers présentant l'icône ![](images/hors_ligne2.png) et de sélectionner "Libérer de l'espace" pour ne garder le fichier que sur le OneDrive.

Pour faire cette opération sur l'intégralité des fichiers et dossiers du OneDrive vous pouvez également cliquer sur l'icône en forme de nuage bleu dans la partie la plus à droite de la barre des tâches (à proximité de l'heure) et cliquer sur l'icône en forme de rouage et de sélectionner "paramètres": 
